    ...
    public class AdsController : Controller
    {
        ...
        public ActionResult ActionPartial(int ID = 0)
        {
            ...
            if (ID != 0)
            {
                ...
                model.WithoutBaseURLPath = Ad.Path;
        ...
        public ActionResult Action(AdsListingViewModel model, string Path,string WithoutBaseURLPath)
        {
            ...
            if (model.ID != 0) //update record
            {
                ...
                {
                    ad.Path = model.WithoutBaseURLPath;
                }
                else
                {
        ...
        [HttpGet]
        public JsonResult GetWithoutBaseURLPathOfAd(int ID)
        {
            var Ad = AdsServices.Instance.GetAds(ID);
            string path = Ad.Path;
            return Json(path, JsonRequestBehavior.AllowGet);
